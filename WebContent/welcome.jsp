...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("form").submit(function(event){
			if($("#name").val()==""||$("#place").val()==""||$("#birthday").val()==""){
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-10" align="left">
				<h5 id="hh5" class="mx-auto font-weight-normal text-secondary text-muted">尊敬的访客，小高欢迎你……</h5>
								...
								*/
								while (rs.next()) {
									...
									out.println("<tr><td>" + rs.getString(2) + "</td><td>" + rs.getString(3) + "</td><td>"
											...
											+ "'>修改</a>&nbsp;<a href='del.jsp?id=" + id + "' id='del'>删除</a></td></tr>");
								}
								rs.close();
								stmt.close();
								con.close();
